require_relative 'lib/navigable/http/version'

Gem::Specification.new do |spec|
  spec.name          = "navigable-http"
  spec.version       = Navigable::HTTP::VERSION
  ...
  spec.homepage      = "https://github.com/first-try-software/navigable-http"
  spec.license       = "MIT"
  spec.required_ruby_version = Gem::Requirement.new(">= 2.7.0")

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/first-try-software/navigable-http"
  spec.metadata["bug_tracker_uri"] = "https://github.com/first-try-software/navigable-http/issues"
